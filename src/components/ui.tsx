...
const STATUS_META: Record<string, { label: string; cls: string }> = {
  ...
  partially_received:{ label: 'Partially received', cls: 'bg-warning-50 text-warning-700 ring-sun-300' },
  received:          { label: 'Received',           cls: 'bg-success-50 text-success-700 ring-brand-200' },
  registered:        { label: 'Registered',         cls: 'bg-ink-100 text-ink-700 ring-ink-200' },
  matched:           { label: 'Matched',            cls: 'bg-success-50 text-success-700 ring-brand-200' },
  exception:         { label: 'Match exception',    cls: 'bg-danger-50 text-danger-700 ring-accent-200' },
